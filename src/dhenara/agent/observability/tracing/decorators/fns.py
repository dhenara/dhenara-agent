...
from dhenara.agent.observability.tracing import NodeTracingProfile, TracingDataField, TracingProfileRegistry, get_tracer
...
def add_profile_values_to_span(span: Span, data_object: Any, fields: list[TracingDataField], prefix: str = "") -> None:
    ...
    for field in fields:
        ...
        attribute_name = f"{prefix}.{field.category.value}.{field.name}"
